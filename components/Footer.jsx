...
const Footer = () => {
  return (
    <footer>
      <div className={styles.Footer__lay}>
        <section className={`row ${styles.Footer__header}`}>
          <section className={`col-desksm-4 ${styles.Footer__header_logo}`}>
            <a href='https://www.lanacion.com.ar/'>
              <img src='images/logo.png' width='250' />
            </a>
          </section>
          <section className={`col-desksm-4 ${styles.Footer__header_redes}`}>
            ...
            <a
              ...
              target='_blank'
            >
              <i className='icon fas fa-rss'></i>
            </a>
          </section>
          <section className={`col-desksm-4 ${styles.Footer__header_app}`}>
            <a
            ...
            <a
              ...
              target='_blank'
              className={styles.Footer__app_ios}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='120'
        ...
        <section className={`row ${styles.Footer__sitio}`}>
          <section
            className={`col-desksm-9 col-deskxl-8 ${styles.Footer__sitio_links}`}
          >
            <a
              href='http://especiales.lanacion.com.ar/varios/mapa-sitio/index.html'
              className={styles.Footer__sitio_links_item_link}
            >
              Mapa del sitio
            </a>
            <a
          ...
          <section
            className={`col-desksm-3 col-deskxl-4 ${styles.Footer__sitio_captcha}`}
          >
            <p>
        ...
        <section className={`row ${styles.Footer__copyright}`}>
          <section
            className={`col-desksm-6 col-desk-6 ${styles.Footer__copyright_fiscal}`}
          >
            <p>
              <img
              ...
              >
                <img
                  ...
                  alt='Data fiscal'
                  className='img_data_fiscal'
                />
              </a>
            </p>
          </section>
          <section
            className={`col-desksm-6 col-desk-6 ${styles.Footer__copyright_reserved}`}
          >
